...
global.practiceVersion = false;
global.startSegment = 1;
...
global.windowCaptionDef = "I wanna Execute The World"; // Sets the default window caption
window_set_caption(global.windowCaptionDef);

global.startRoom = rMiku; // Sets which room for the game to begin with
...
#macro MD5_STR_ADD "world.execute(me)" // Sets what to add to the end of md5 input string to make saves harder to hack, should be set to something unique and hard to predict (similar to setting a password)
